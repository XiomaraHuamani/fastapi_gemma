...
def upgrade() -> None:
    ...
    sa.Column('linea_base', sa.Enum('primera_linea', 'segunda_linea', 'tercera_linea', name='lineabaseenum'), nullable=True),
    sa.Column('tiene_subniveles', sa.Boolean(), nullable=True),
    ...
    op.create_index(op.f('ix_zonas_tiene_subniveles'), 'zonas', ['tiene_subniveles'], unique=False)
    ...
    sa.Column('subnivel_de_id', sa.Integer(), nullable=True),
    sa.Column('cliente_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['cliente_id'], ['clientes.id'], ),
    sa.ForeignKeyConstraint(['metraje_id'], ['metrajes.id'], ),
    sa.ForeignKeyConstraint(['subnivel_de_id'], ['locales.id'], ),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_zonas_tiene_subniveles'), table_name='zonas')
